        ...
        if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
            echo "<tr>
                            ...
                            <td>
                                <a href='edit-event.php?id=" . $row["id"] . "' class='btn btn-warning'>Edit</a>
                                <a href='delete-event.php?id=" . $row["id"] . "' class='btn btn-danger'>Delete</a>
                            </td>
                            <td>
                                <a href='detail-event.php?id=" . $row["id"] . "' class='btn btn-info'>Lihat Detail</a>
                            </td>
                        </tr>";
          }
        } else {
